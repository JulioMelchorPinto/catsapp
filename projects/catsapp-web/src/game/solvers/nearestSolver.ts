...
class Blocks {
    ...
    /*
    * Método de goteo BFS encuentra la distancia de cada bloque al borde
    * 
    * 1. Inicialice una cola, agregue todos los bloques de límites y establezca la distancia en 0
    * 2. Atraviesa cada elemento en la cola, por los 6 bloques adyacentes a su alrededor
    *  Si no hay recorrido, establezca la distancia actual + 1
    *  Si se atraviesa, ajústelo al valor más pequeño entre su distancia y la distancia actual + 1
    */
    calcAllDistances() {
        let queue: Block[] = [];
