!(function (t) {
      ...
      return (
        ...
        Object.defineProperty(e.prototype, "state", {
          ...
          set: function (t) {
            switch (t) {
              ...
              case i.WIN:
                this.setStatusText(
                  f.default("El gato no tiene camino a seguir, tú ganas")
                );
                break;
              default:
                return;
        ...
        (e.prototype.playerClick = function (t, e) {
          if (
            ...
            return (
              this.setStatusText(
                f.default("El juego ha terminado, comienza de nuevo")
              ),
              this.reset(),
              !1
            );
              ...
              : ((n.isWall = !0),
                this.cat.isCaught()
                  ? (this.setStatusText(
                    ...
                    !1)
                  : (this.setStatusText(
                      f.default("Hiciste clic") + "(" + t + ", " + e + ")"
                    ),
                    this.cat.step() ||
                      (this.setStatusText(
                        f.default("¡El gato admite la derrota y tú ganas!")
                      ),
                      (this.state = i.WIN)),
                    !0))
            : (this.setStatusText(
                f.default("Error de código, la posición actual no existe")
              ),
              !1);
        }),
        (e.prototype.reset = function () {
          this.cat.reset(),
            ...
            (this.state = i.PLAYING),
            this.setStatusText(
              f.default("Haz clic en los puntos para rodear al gatito.")
            );
        }),
  ...
  function (t, e, n) {
    ...
    var i = n(2),
      s = (function (t) {
        function e(e) {
          var n = t.call(this, e, 0, 0, i.default("Reiniciar"), {}) || this;
          n.setColor("#000000");
          var o = e.r;
          n.setFontSize(o),
